...
| 4 | How Do We Get There? | Improvement initiatives planned and assigned |
| 5 | Take Action | Changes implemented in scheduled phases |
| 6 | Did We Get There? | Results measured against success metrics |
| 7 | How Do We Keep Momentum? | CIR reviewed monthly and updated continuously |
...
| Average P3 Resolution Time | 18 Hours |
| Password Reset Tickets | ~18% Of Ticket Volume |
| Proactive Monitoring Coverage | 40% |
...
Monitoring thresholds will detect:
- CPU Utilization
- Memory Usage
- Disk Capacity
...
| Knowledge Management | Improvement documentation supports operational learning |
...
| Optimize And Automate | Repetitive manual tasks targeted for automation |
